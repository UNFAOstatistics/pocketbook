...
if (Sys.info()[["user"]] == "markus" & Sys.info()[["sysname"]] == "Windows")   root.dir <- "C:/temp/regional15/" # Amy
...
if (Sys.info()[["sysname"]] == "Windows") load("E:/btsync/faosync/syb_database/output_data/2015-12-08-01/SYB2015-12-08-01.RData")
if (Sys.info()[["sysname"]] != "Windows") load("~/btsync/faosync/syb_database/output_data/2015-12-04-01/SYB2015-12-04-01.RData")
...
if (gpclibPermitStatus() != TRUE) gpclibPermit()
