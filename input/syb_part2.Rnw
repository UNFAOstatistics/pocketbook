...
if (region_to_report == "GLO") dat <- dat[which(dat$GLO),]
...
if (region_to_report == "RAF") map.plot <- map.plot[which(map.plot$RAF),]
if (region_to_report == "RAP") map.plot <- map.plot[which(map.plot$RAP),]
if (region_to_report == "REU") map.plot <- map.plot[which(map.plot$REU),]
if (region_to_report == "RNE") map.plot <- map.plot[which(map.plot$RNE),]
if (region_to_report == "GLO") map.plot <- map.plot[which(map.plot$GLO),]
if (region_to_report == "COF") map.plot <- map.plot
