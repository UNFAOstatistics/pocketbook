...
<<P2undernuTOPRIGHT, eval=P2undernu, top_right_minitable=P2undernu, fig.height=2.5, fig.width=3>>=
...
<<P2undernuLEFT, eval=P2undernu, left_plot=P2undernu, fig.height=5.9, fig.width=3.2>>=
# data
...
<<P2undernuRIGHT, eval=P2undernu ,right_plot=P2undernu, fig.height=5.9, fig.width=3.2>>=
...
<<P2undernuBOTTOM, eval=P2undernu, bottom_plot=P2undernu, fig.height=3, fig.width=6>>=
