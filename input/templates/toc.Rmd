...
- [Google sheet for comparison](https://docs.google.com/spreadsheets/d/1qJ0NIP5s8aEA7ew8WEe_GBjOsk-DjJmEUQrlvPIyiRI/edit#gid=1197190715)
- [Pocketbook tests](http://software.markuskainu.fi/fao/pocketbook_tests/)
- [Final data tests](datatests.html)
...
1. [all faostat in single csv (first 1000 lines)](data/faostat.csv) - *original has 72 million rows, 7,2 GB as .csv*
1. [metadata for the above](data/meta_faostat.csv)
1. [country level indicators for the book before aggregation](data/data_for_book.csv)
