...
source(paste0(root.dir,"input/code/table/ZsanitizeToLatex.R"))
...
if (region_to_report == "RAF") M49countries <- M49countries[which(M49countries$RAF),]
if (region_to_report == "RAP") M49countries <- M49countries[which(M49countries$RAP),]
if (region_to_report == "REU") M49countries <- M49countries[which(M49countries$REU),]
if (region_to_report == "RNE") M49countries <- M49countries[which(M49countries$RNE),]
if (region_to_report == "GLO") M49countries <- M49countries[which(M49countries$GLO),]
if (region_to_report == "COF") M49countries <- M49countries
...
if (region_to_report == "RAF") indicators.df <- read.csv(paste0(root.dir,"input/data/RAF/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
if (region_to_report == "RAP") indicators.df <- read.csv(paste0(root.dir,"input/data/RAP/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
if (region_to_report == "REU") indicators.df <- read.csv(paste0(root.dir,"input/data/REU/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
if (region_to_report == "RNE") indicators.df <- read.csv(paste0(root.dir,"input/data/RNE/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
if (region_to_report == "GLO") indicators.df <- read.csv(paste0(root.dir,"input/data/RAF/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
if (region_to_report == "COF") indicators.df <- read.csv(paste0(root.dir,"input/data/RAF/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
