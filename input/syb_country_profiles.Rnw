...
if (!("malnutrition_prevalence" %in% names(syb.df)) & region_to_report == "REU"){
  ...
  dat1 <- dat1[c("FAOST_CODE","YEAR","Numeric")]
...
# Stunting: WDI, called Malnutrition prevalence, height for age
# Wasting: WDI, called Prevalence of wasting (% of children under 5)
# Overweight, children: WDI, Prevalence of overweight (% of children under 5)
# Obesity, children under 19: ???
# Overweight, adults:  WHO, http://apps.who.int/gho/data/node.main.A896?lang=en
# Obesity: WHO, http://apps.who.int/gho/data/node.main.A896?lang=en
# Vitamin A deficiency, children: ??
# Vitamin A deficiency, total pop: FSI
# Anemia, children under 5: FSI
# Anemia, women in reproductive age: We do not have this. Instead we have Prevalence of anemia among pregnant women, FSI
# Iodine deficiency, children: ??
# Iodine deficiency, total pop: FSI
# Health expenditure, total: WDI
# Health expenditure per capita PPP: WDI 
...
M49countries <- left_join(M49countries,region_key)
...
if (region_to_report == "RAF") tbl_row_height <- 1.12
if (region_to_report == "RAP") tbl_row_height <- 1.02
