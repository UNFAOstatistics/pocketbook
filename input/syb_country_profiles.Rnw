...
if (!("FS.DA.ADESA.PCT3D" %in% names(syb.df))) {
  ...
  # RAF
  dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 12000 # Regional Office for Africa
  ...
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 12003 # North Africa missing for SOFI
  
  # RAP
  dat$FAOST_CODE[dat$FAOST_CODE == 5853] <- 13000  #  Regional Office for Asia and the Pacific
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13001  #	East Asia
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13002  #	Pacific Islands
  dat$FAOST_CODE[dat$FAOST_CODE == 5304] <- 13003  #	Southeast Asia
  ...
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13006  #	Australia New Zealand
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13007  #	France
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13008  #	Melanesia
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13009  #	Micronesia
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13010  #	Polynesia
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13011  #	Russian Federation
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13012  #	Southern Asia
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 13013  #	United States
  dat$FAOST_CODE[dat$FAOST_CODE == 5856] <- 13014  #	Western Asia
  
  # REU  - ALL MISSING FROM SOFI
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 14000 # Regional Office for Europe and Central Asia
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 14001 # REU Caucasus and Turkey
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 14002 # REU Central Asia
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 14003 # REU Central Eastern Europe
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 14004 # REU CIS Europe
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 14005 # Israel
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 14006 # REU Other and EFTA
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 14007 # REU South Eastern Europe
  
  # RNE - ALL MISSING FROM SOFI
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 15000 # Regional Office for the Near East
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 15001 # Gulf Cooperation Council States and Yemen
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 15002 # North Africa
  # dat$FAOST_CODE[dat$FAOST_CODE == 5100] <- 15003 # Other Near East countries
