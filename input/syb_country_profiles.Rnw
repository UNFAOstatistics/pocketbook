...
if (region_to_report == "RNE") indicators.df <- read.csv(paste0(root.dir,"input/data/RNE/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
if (region_to_report == "GLO") indicators.df <- read.csv(paste0(root.dir,"input/data/GLO/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
if (region_to_report == "COF") indicators.df <- read.csv(paste0(root.dir,"input/data/COF/country_profile_indicators.csv"), 
                                                         na.strings = "", stringsAsFactors = FALSE)
