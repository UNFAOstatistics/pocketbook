...
if (region_to_report == "RAF") caption_text <- "Labour force participation rate by gender, ages 15+ (2013)"
if (region_to_report == "RAP") caption_text <- "Labour force participation rate by gender, ages 15+ (2013)"
if (region_to_report == "REU") caption_text <- "Labour force participation rate by gender, ages 15+ (2013)"
if (region_to_report == "RNE") caption_text <- "Labour force participation rate by gender, ages 15+ (2013)"
if (region_to_report == "GLO") caption_text <- "Labour force participation rate by gender, ages 15+ (2013)"
@
...
if (region_to_report == "RAF") caption_text <- "Female employment in agriculture, share of female employment (2013)"
if (region_to_report == "RAP") caption_text <- "Female employment in agriculture, share of female employment (2013)"
if (region_to_report == "REU") caption_text <- "Female employment in agriculture, share of female employment (2013)"
if (region_to_report == "RNE") caption_text <- "Female employment in agriculture, share of female employment (2013)"
if (region_to_report == "GLO") caption_text <- "Female employment in agriculture, share of female employment (2013)"
...
if (region_to_report == "RAF") caption_text <- "Male employment in agriculture, share of Male employment (2013)"
if (region_to_report == "RAP") caption_text <- "Male employment in agriculture, share of Male employment (2013)"
if (region_to_report == "REU") caption_text <- "Male employment in agriculture, share of Male employment (2013)"
if (region_to_report == "RNE") caption_text <- "Male employment in agriculture, share of Male employment (2013)"
if (region_to_report == "GLO") caption_text <- "Male employment in agriculture, share of Male employment (2013)"

@


<<P1laboBOTTOM_data, cache=TRUE, results='hide'>>=
# data
...
if (region_to_report == "RAF") caption_text <- "Female employment in agriculture, share of female employment (2000-2014)"
if (region_to_report == "RAP") caption_text <- "Female employment in agriculture, share of female employment (2000-2014)"
if (region_to_report == "REU") caption_text <- "Female employment in agriculture, share of female employment (2000-2014)"
if (region_to_report == "RNE") caption_text <- "Female employment in agriculture, share of female employment (2000-2014)"
if (region_to_report == "GLO") caption_text <- "Female employment in agriculture, share of female employment (2000-2014)"
...
if (region_to_report == "RAF") caption_text <- "Employment in agriculture, share of total employment (2007-2012)"
if (region_to_report == "RAP") caption_text <- "Employment in agriculture, share of total employment (2007-2012)"
if (region_to_report == "REU") caption_text <- "Employment in agriculture, share of total employment (2007-2012)"
if (region_to_report == "RNE") caption_text <- "Employment in agriculture, share of total employment (2007-2012)"
if (region_to_report == "GLO") caption_text <- "Employment in agriculture, share of total employment (2007-2012)"
@
...
if (region_to_report == "RAF") caption_text <- "Fertilizer consumption in nutrients per ha of arable land in RAF"
if (region_to_report == "RAP") caption_text <- "Fertilizer consumption in nutrients per ha of arable land in RAP"
if (region_to_report == "REU") caption_text <- "Fertilizer consumption in nutrients per ha of arable land in REU"
if (region_to_report == "RNE") caption_text <- "Fertilizer consumption in nutrients per ha of arable land in RNE"
if (region_to_report == "GLO") caption_text <- "Fertilizer consumption in nutrients per ha of arable land in GLO"
@
...
if (region_to_report == "RAF") caption_text <- "Nitrogen fertilizers consumption in nutrients per ha of arable land"
if (region_to_report == "RAP") caption_text <- "Nitrogen fertilizers consumption in nutrients per ha of arable land"
if (region_to_report == "REU") caption_text <- "Nitrogen fertilizers consumption in nutrients per ha of arable land"
if (region_to_report == "RNE") caption_text <- "Nitrogen fertilizers consumption in nutrients per ha of arable land"
if (region_to_report == "GLO") caption_text <- "Nitrogen fertilizers consumption in nutrients per ha of arable land"
...
if (region_to_report == "RAF") caption_text <- "Phosphate fertilizers consumption in nutrients per ha of arable land"
if (region_to_report == "RAP") caption_text <- "Phosphate fertilizers consumption in nutrients per ha of arable land"
if (region_to_report == "REU") caption_text <- "Phosphate fertilizers consumption in nutrients per ha of arable land"
if (region_to_report == "RNE") caption_text <- "Phosphate fertilizers consumption in nutrients per ha of arable land"
if (region_to_report == "GLO") caption_text <- "Phosphate fertilizers consumption in nutrients per ha of arable land"
...
if (region_to_report == "RAF") caption_text <- "Fertilizer consumption in nutrients per ha of arable land (2012)"
if (region_to_report == "RAP") caption_text <- "Fertilizer consumption in nutrients per ha of arable land (2012)"
if (region_to_report == "REU") caption_text <- "Fertilizer consumption in nutrients per ha of arable land (2012)"
if (region_to_report == "RNE") caption_text <- "Fertilizer consumption in nutrients per ha of arable land (2012)"
if (region_to_report == "GLO") caption_text <- "Fertilizer consumption in nutrients per ha of arable land (2012)"
...
if (region_to_report == "RAF") caption_text <- "Pesticides per ha of arable land (kg/ha, 2007 to 2012*)"
if (region_to_report == "RAP") caption_text <- "Pesticides per ha of arable land (kg/ha, 2007 to 2012*)"
if (region_to_report == "REU") caption_text <- "Pesticides per ha of arable land (kg/ha, 2007 to 2012*)"
if (region_to_report == "RNE") caption_text <- "Pesticides per ha of arable land (kg/ha, 2007 to 2012*)"
if (region_to_report == "GLO") caption_text <- "Pesticides per ha of arable land (kg/ha, 2007 to 2012*)"
@
...
<<P1investData,results='hide', cache=TRUE>>=
...
if (region_to_report == "RAF") caption_text <- "Aid flows to agriculture, share of total aid (1995-2013)"
if (region_to_report == "RAP") caption_text <- "Aid flows to agriculture, share of total aid (1995-2013)"
if (region_to_report == "REU") caption_text <- "Aid flows to agriculture, share of total aid (1995-2013)"
if (region_to_report == "RNE") caption_text <- "Aid flows to agriculture, share of total aid (1995-2013)"
if (region_to_report == "GLO") caption_text <- "Aid flows to agriculture, share of total aid (1995-2013)"
...
if (region_to_report == "RAF") caption_text <- "Total credit to agriculture, top 20 countries in 2014 (2000 and 2012)"
if (region_to_report == "RAP") caption_text <- "Total credit to agriculture, top 20 countries in 2014 (2000 and 2012)"
if (region_to_report == "REU") caption_text <- "Total credit to agriculture, top 20 countries in 2014 (2000 and 2012)"
if (region_to_report == "RNE") caption_text <- "Total credit to agriculture, top 20 countries in 2014 (2000 and 2012)"
if (region_to_report == "GLO") caption_text <- "Total credit to agriculture, top 20 countries in 2014 (2000 and 2012)"
...
if (region_to_report == "RAF") caption_text <- "Aid flows to agriculture, broad (1995-2013) - NO COUNTRY LEVEL DATA???"
if (region_to_report == "RAP") caption_text <- "Aid flows to agriculture, broad (1995-2013) - NO COUNTRY LEVEL DATA???"
if (region_to_report == "REU") caption_text <- "Aid flows to agriculture, broad (1995-2013) - NO COUNTRY LEVEL DATA???"
if (region_to_report == "RNE") caption_text <- "Aid flows to agriculture, broad (1995-2013) - NO COUNTRY LEVEL DATA???"
if (region_to_report == "GLO") caption_text <- "Aid flows to agriculture, broad (1995-2013) - NO COUNTRY LEVEL DATA???"

@

<<p1investMAPdata, results='hide', cache=TRUE>>=
...
<<P1povertyTEXT, eval=P1poverty, short_text_ChartPage=P1poverty>>=
...
<<P1povertyData, cache=TRUE,results='hide', eval=P1poverty>>=
...
<<P1povertyTOPRIGHT, eval=P1poverty, top_right_plot=P1poverty, fig.height=top_right_plot_height, fig.width=top_right_plot_width>>=
...
if (region_to_report == "RAF") caption_text <- "Countries with the lowest renewable water resources per capita"
if (region_to_report == "RAP") caption_text <- "Countries with the lowest renewable water resources per capita"
if (region_to_report == "REU") caption_text <- "Countries with the lowest renewable water resources per capita"
if (region_to_report == "RNE") caption_text <- "Countries with the lowest renewable water resources per capita"
if (region_to_report == "GLO") caption_text <- "Countries with the lowest renewable water resources per capita"
@


<<P1povertyLEFT, eval=P1poverty, left_plot=P1poverty, fig.height=left_plot_height, fig.width=left_plot_width>>=

plot(cars)

# Caption
caption_text <- "Freshwater withdrawal by industrial sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "RAF") caption_text <- "Freshwater withdrawal by industrial sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "RAP") caption_text <- "Freshwater withdrawal by industrial sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "REU") caption_text <- "Freshwater withdrawal by industrial sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "RNE") caption_text <- "Freshwater withdrawal by industrial sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "GLO") caption_text <- "Freshwater withdrawal by industrial sector, share of total, highest 20 (1999 to 2013)"

@

<<P1povertyRIGHT, eval=P1poverty ,right_plot=P1poverty, fig.height=right_plot_height, fig.width=right_plot_width>>=

plot(cars)

# Caption
caption_text <- "Freshwater withdrawal by agricultural sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "RAF") caption_text <- "Freshwater withdrawal by agricultural sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "RAP") caption_text <- "Freshwater withdrawal by agricultural sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "REU") caption_text <- "Freshwater withdrawal by agricultural sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "RNE") caption_text <- "Freshwater withdrawal by agricultural sector, share of total, highest 20 (1999 to 2013)"
if (region_to_report == "GLO") caption_text <- "Freshwater withdrawal by agricultural sector, share of total, highest 20 (1999 to 2013)"

@


<<P1povertyBOTTOM, eval=P1poverty, bottom_plot=P1poverty, fig.height=bottom_plot_height, fig.width=bottom_plot_width>>=
...
<<P1povertyMAP, eval=P1poverty, map_plot=P1poverty, fig.width=map.fig.width, fig.height= map.fig.height ,out.width=map.out.width, out.height=map.out.height, out.extra=map.out.extra>>=
plot(cars)

# Caption
caption_text <- "Freshwater resources withdrawn by agriculture (percent, 1999-2013*)"
if (region_to_report == "RAF") caption_text <- "Freshwater resources withdrawn by agriculture (percent, 1999-2013*)"
if (region_to_report == "RAP") caption_text <- "Freshwater resources withdrawn by agriculture (percent, 1999-2013*)"
if (region_to_report == "REU") caption_text <- "Freshwater resources withdrawn by agriculture (percent, 1999-2013*)"
if (region_to_report == "RNE") caption_text <- "Freshwater resources withdrawn by agriculture (percent, 1999-2013*)"
if (region_to_report == "GLO") caption_text <- "Freshwater resources withdrawn by agriculture (percent, 1999-2013*)"
@
