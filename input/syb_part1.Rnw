...
<<P1overTOPRIGHT, eval=P1over, top_right_chunk=P1over>>=
# data
df <- mtcars
...
<<P1overLEFT, eval=P1over, left_chunk=P1over>>=
...
<<P1overRIGHT, eval=P1over ,right_chunk=P1over>>=
...
<<P1overBOTTOM, eval=P1over, bottom_chunk=P1over>>=
...
<<P1overMAP, eval=P1over, map_chunk=P1over>>=
