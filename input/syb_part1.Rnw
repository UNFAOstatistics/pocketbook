...
# generate the object
if (region_to_report == "COF") caption_text <- "Diamond price by the colour of the diamond on the top right"
if (region_to_report == "GLO") caption_text <- "Diamond price by the colour of the diamond on the top right"
