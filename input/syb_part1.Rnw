...
#source(paste0(root.dir,'./input/code/plot/plot_setup.R'))
...
<<part1_example_text, text_chunk=TRUE>>=
...
<<part1_example_toprigth, top_right_chunk=TRUE>>=
# data
df <- mtcars
...
<<part1_example_left, left_chunk=TRUE>>=
...
<<part1_example_right,right_chunk=TRUE>>=
...
<<part1_example_bottom,bottom_chunk=TRUE>>=
...
<<part1_example_end, end_chunk=TRUE>>=
@


<<part1_example_map,map_chunk=TRUE>>=
