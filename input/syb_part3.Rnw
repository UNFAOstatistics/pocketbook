...
<<P3desData,results='hide', cache=TRUE, eval=P3des>>=
# Retrieve data
...
dat <- join(dat[c("FAOST_CODE","var","mean")],pop)
...
<<P3cropproData,results='hide', cache=TRUE, eval=P3croppro>>=
...
if (region_to_report == "RAF") caption_text <- "Top 20 crop producing countries in 2012 based on net per capita crop production value"
if (region_to_report == "RAP") caption_text <- "Top 20 crop producing countries in 2012 based on net per capita crop production value"
if (region_to_report == "REU") caption_text <- "Top 20 crop producing countries in 2012 based on net per capita crop production value"
if (region_to_report == "RNE") caption_text <- "Top 20 crop producing countries in 2012 based on net per capita crop production value"
if (region_to_report == "GLO") caption_text <- "Top 20 crop producing countries in 2012 based on net per capita crop production value"
...
if (region_to_report == "RAF") caption_text <- "Top 20 food producing countries in 2012 based on net food per capita production value"
if (region_to_report == "RAP") caption_text <- "Top 20 food producing countries in 2012 based on net food per capita production value"
if (region_to_report == "REU") caption_text <- "Top 20 food producing countries in 2012 based on net food per capita production value"
if (region_to_report == "RNE") caption_text <- "Top 20 food producing countries in 2012 based on net food per capita production value"
if (region_to_report == "GLO") caption_text <- "Top 20 food producing countries in 2012 based on net food per capita production value"
@
...
# Caption
caption_text <- "This is the default caption if no region spesific is defined"
if (region_to_report == "RAF") caption_text <- "Number of people undernourished, top 5 countries from region"
if (region_to_report == "RAP") caption_text <- "Number of people undernourished, top 5 countries from region"
if (region_to_report == "REU") caption_text <- "Number of people undernourished, top 5 countries from region"
if (region_to_report == "RNE") caption_text <- "Number of people undernourished, top 5 countries from region"
if (region_to_report == "GLO") caption_text <- "Number of people undernourished, top 5 countries"
...
if (region_to_report == "RAF") caption_text <- "Crops, gross per capita production index (2004-06 = 100, 2013)"
if (region_to_report == "RAP") caption_text <- "Crops, gross per capita production index (2004-06 = 100, 2013)"
if (region_to_report == "REU") caption_text <- "Crops, gross per capita production index (2004-06 = 100, 2013)"
if (region_to_report == "RNE") caption_text <- "Crops, gross per capita production index (2004-06 = 100, 2013)"
if (region_to_report == "GLO") caption_text <- "Crops, gross per capita production index (2004-06 = 100, 2013)"
@
...
<<P3cropData,results='hide',cache=TRUE,eval=P3crop>>=
...
if (region_to_report == "RAF") caption_text <- "Top 20 rice producing countries, per capita"
if (region_to_report == "RAP") caption_text <- "Top 20 rice producing countries, per capita"
if (region_to_report == "REU") caption_text <- "Top 20 rice producing countries, per capita"
if (region_to_report == "RNE") caption_text <- "Top 20 rice producing countries, per capita"
if (region_to_report == "GLO") caption_text <- "Top 20 rice producing countries, per capita"
...
if (region_to_report == "RAF") caption_text <- "Top 20 wheat producing countries, per capita"
if (region_to_report == "RAP") caption_text <- "Top 20 wheat producing countries, per capita"
if (region_to_report == "REU") caption_text <- "Top 20 wheat producing countries, per capita"
if (region_to_report == "RNE") caption_text <- "Top 20 wheat producing countries, per capita"
if (region_to_report == "GLO") caption_text <- "Top 20 wheat producing countries, per capita"
@
...
if (region_to_report == "RAF") caption_text <- "Cereals, yield"
if (region_to_report == "RAP") caption_text <- "Cereals, yield"
if (region_to_report == "REU") caption_text <- "Cereals, yield"
if (region_to_report == "RNE") caption_text <- "Cereals, yield"
if (region_to_report == "GLO") caption_text <- "Cereals, yield"
...
if (region_to_report == "RAF") caption_text <- "Cereal production, tonnes/cap (2013)"
if (region_to_report == "RAP") caption_text <- "Cereal production, tonnes/cap (2013)"
if (region_to_report == "REU") caption_text <- "Cereal production, tonnes/cap (2013)"
if (region_to_report == "RNE") caption_text <- "Cereal production, tonnes/cap (2013)"
if (region_to_report == "GLO") caption_text <- "Cereal production, tonnes/cap (2013)"
@
...
<<P3livestockData,results='hide',cache=TRUE,eval=P3livestock>>=
...
if (region_to_report == "RAF") caption_text <- "Total milk production, top and bottom 10 countries (2012)"
if (region_to_report == "RAP") caption_text <- "Total milk production, top and bottom 10 countries (2012)"
if (region_to_report == "REU") caption_text <- "Total milk production, top and bottom 10 countries (2012)"
if (region_to_report == "RNE") caption_text <- "Total milk production, top and bottom 10 countries (2012)"
if (region_to_report == "GLO") caption_text <- "Total milk production, top and bottom 10 countries (2012)"
...
if (region_to_report == "RAF") caption_text <- "Total egg production, top and bottom 10 countries (2012)"
if (region_to_report == "RAP") caption_text <- "Total egg production, top and bottom 10 countries (2012)"
if (region_to_report == "REU") caption_text <- "Total egg production, top and bottom 10 countries (2012)"
if (region_to_report == "RNE") caption_text <- "Total egg production, top and bottom 10 countries (2012)"
if (region_to_report == "GLO") caption_text <- "Total egg production, top and bottom 10 countries (2012)"
...
if (region_to_report == "RAF") caption_text <- "Pig production (heads)"
if (region_to_report == "RAP") caption_text <- "Pig production (heads)"
if (region_to_report == "REU") caption_text <- "Pig production (heads)"
if (region_to_report == "RNE") caption_text <- "Pig production (heads)"
if (region_to_report == "GLO") caption_text <- "Pig production (heads)"
...
if (region_to_report == "RAF") caption_text <- "Cattle and buffaloes per ha of agricultural area, heads per ha (2012)"
if (region_to_report == "RAP") caption_text <- "Cattle and buffaloes per ha of agricultural area, heads per ha (2012)"
if (region_to_report == "REU") caption_text <- "Cattle and buffaloes per ha of agricultural area, heads per ha (2012)"
if (region_to_report == "RNE") caption_text <- "Cattle and buffaloes per ha of agricultural area, heads per ha (2012)"
if (region_to_report == "GLO") caption_text <- "Cattle and buffaloes per ha of agricultural area, heads per ha (2012)"
@
...
<<P3fisheriesData,results='hide',cache=TRUE,eval=FALSE>>=
...
if (region_to_report == "RAF") caption_text <- "Per capita fish food supply ONLY GLOBAL LEVEL DATA"
if (region_to_report == "RAP") caption_text <- "Per capita fish food supply ONLY GLOBAL LEVEL DATA"
if (region_to_report == "REU") caption_text <- "Per capita fish food supply ONLY GLOBAL LEVEL DATA"
if (region_to_report == "RNE") caption_text <- "Per capita fish food supply ONLY GLOBAL LEVEL DATA"
if (region_to_report == "GLO") caption_text <- "Per capita fish food supply ONLY GLOBAL LEVEL DATA"
@
...
<<P3tradeData,results='hide',cache=TRUE,eval=P3trade>>=
# This should be thought twice how to produce it for regional books!
# Retrieve data
library(FAOSTAT)
...
if (region_to_report == "RAF") caption_text <- "Top food importing countries in 2012"
if (region_to_report == "RAP") caption_text <- "Top food importing countries in 2012"
if (region_to_report == "REU") caption_text <- "Top food importing countries in 2012"
if (region_to_report == "RNE") caption_text <- "Top food importing countries in 2012"
if (region_to_report == "GLO") caption_text <- "Top food importing countries in 2012"
...
if (region_to_report == "RAF") caption_text <- "Top food exporting countries in 2012"
if (region_to_report == "RAP") caption_text <- "Top food exporting countries in 2012"
if (region_to_report == "REU") caption_text <- "Top food exporting countries in 2012"
if (region_to_report == "RNE") caption_text <- "Top food exporting countries in 2012"
if (region_to_report == "GLO") caption_text <- "Top food exporting countries in 2012"
@
...
if (region_to_report == "RAF") caption_text <- "Exports of cereals"
if (region_to_report == "RAP") caption_text <- "Exports of cereals"
if (region_to_report == "REU") caption_text <- "Exports of cereals"
if (region_to_report == "RNE") caption_text <- "Exports of cereals"
if (region_to_report == "GLO") caption_text <- "Exports of cereals"
...
if (region_to_report == "RAF") caption_text <- "Import value index (2004-2006 = 100, 2011)"
if (region_to_report == "RAP") caption_text <- "Import value index (2004-2006 = 100, 2011)"
if (region_to_report == "REU") caption_text <- "Import value index (2004-2006 = 100, 2011)"
if (region_to_report == "RNE") caption_text <- "Import value index (2004-2006 = 100, 2011)"
if (region_to_report == "GLO") caption_text <- "Import value index (2004-2006 = 100, 2011)"
@
