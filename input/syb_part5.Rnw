...
<<P5overData,results='hide', cache=FALSE>>=
@
...
<<P5povertyData, cache=FALSE,results='hide', eval=P5poverty>>=
@
...
<<P5desData,results='hide', cache=FALSE, eval=P5des>>=
@
