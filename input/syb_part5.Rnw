...
<<P5extra1TEXT, eval=P5extra1, short_text_ChartPage=P5extra1>>=
spread_title <- "Land"
...
<<P5extra1Data,results='hide'>>=


@


<<P5extra1TOPRIGHT, eval=P5extra1, top_right_plot=P5extra1, fig.height=top_right_plot_height, fig.width=top_right_plot_width>>=
...
<<P5extra1LEFT, eval=P5extra1, left_plot=P5extra1, fig.height=left_plot_height, fig.width=left_plot_width>>=
...
<<P5extra1RIGHT, eval=P5extra1 ,right_plot=P5extra1, fig.height=right_plot_height, fig.width=right_plot_width>>=
dat_plot <- bottom20
...
<<P5extra1BOTTOM, eval=P5extra1, bottom_plot=P5extra1, fig.height=bottom_plot_height, fig.width=bottom_plot_width>>=
...
<<P5extra1MAP, eval=P5extra1, map_plot=P5extra1, fig.width=map.fig.width, fig.height= map.fig.height ,out.width=map.out.width, out.height=map.out.height, out.extra=map.out.extra>>=
dat <- filter(syb.df, Year %in% 2012) %>% select(FAOST_CODE,
