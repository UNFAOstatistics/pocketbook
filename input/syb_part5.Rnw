...
<<P5coffeeTEXT, eval=P5coffee, short_text_ChartPage=P5coffee>>=
...
<<P5coffeeData,results='hide'>>=


@


<<P5coffeeTOPRIGHT, eval=P5coffee, top_right_plot=P5coffee, fig.height=top_right_plot_height, fig.width=top_right_plot_width>>=
...
<<P5coffeeLEFT, eval=P5coffee, left_plot=P5coffee, fig.height=left_plot_height, fig.width=left_plot_width>>=
...
<<P5coffeeRIGHT, eval=P5coffee ,right_plot=P5coffee, fig.height=right_plot_height, fig.width=right_plot_width>>=
dat_plot <- bottom20
...
<<P5coffeeBOTTOM, eval=P5coffee, bottom_plot=P5coffee, fig.height=bottom_plot_height, fig.width=bottom_plot_width>>=
...
<<P5coffeeMAP, eval=P5coffee, map_plot=P5coffee, fig.width=map.fig.width, fig.height= map.fig.height ,out.width=map.out.width, out.height=map.out.height, out.extra=map.out.extra>>=
dat <- filter(syb.df, Year %in% 2012) %>% select(FAOST_CODE,
