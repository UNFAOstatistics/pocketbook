...
REU_EU_other_and_EFTA <- c(11, #Austria
                        255, #Belgium
...
REU_Andorra_Israel_Monaco_and_San_Marino <- c(6, #Andorra
              140, # Monaco
              192, # San Marino
              105 # Israel
              )
...
REU <- c(REU_South_Eastern_Europe,
         ...
         # REU_Israel,
         REU_Central_Asia,
         REU_Andorra_Israel_Monaco_and_San_Marino
)
...
region_key$REU_Andorra_Israel_Monaco_and_San_Marino                   <- ifelse(region_key$FAOST_CODE %in% REU_Andorra_Israel_Monaco_and_San_Marino, TRUE, FALSE)
