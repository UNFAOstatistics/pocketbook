...
if (upload_pdfs_to_server) {
  ...
  pdfs <- c(pdfs,"/home/markus/btsync/faosync/pocketbooks/regional15//output/pdf/agg_pic.pdf")
  pdfs <- pdfs[!(pdfs %in% c("/home/markus/btsync/faosync/pocketbooks/regional15//output/pdf/agg_pic.pdf",
                             "/home/markus/btsync/faosync/pocketbooks/regional15//output/pdf/table_pic.pdf"))]
