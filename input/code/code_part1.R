...
if (region_to_report == "RNE") short_text <- "The declining mortality rates combined with a moderate life expectancy and supported by an extreme fertility contributes to population growth in the world. While growth rates have been slowing since the late 1960s in rural areas, they keep almost constant in the urban ones. Population growth is generally higher in the Gulf countries like Qatar United Arab Emirates, Bahrain and Kuwait compared to middle income countries like Morocco, Tunisia and Iran. The last two decades show that there have been more people living in cities than in rural areas. "
...
if (region_to_report == "RNE") short_text <- "Adequate access to inputs, including land, pesticides and fertilizers, is vital for agricultural production and growth. Within the region, it is evident the use of large quantities of fertilizer, nitrogen in specific. However, fertilizer use is not homogenous within the region as the Gulf countries consume more than five times nutrients per hectare than Near East and North Africa countries. This is mainly due to the difficult and costly expansion of arable land within the desert environment."
