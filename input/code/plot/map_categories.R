categories <- function(x, n=5,method="jenks",manual=FALSE,manual_breaks = NULL,decimals=0,translateru=rulang) {
  ...
  if (translateru) levels(y)[levels(y) == "No Data"] <- "нет данных"
  y
}