...
if (region_to_report == "RAF") short_text <- "The severity and speed of climate change is presenting an unprecedented challenge. Current global surface temperatures are now about 0.6 degrees Celsius higher than the average for the last century. This increase is consistent with model predictions of the effects of rising atmospheric concentrations of carbon dioxide (CO2) and other GHGs, which are a result of human activity. Compared to global figures, greenhouse gas emissions in agriculture from Africa are considerably low, the highest been about 300,000 gigagrams CO2eq as compared to over 2million gigagrams CO2eq globally in 2010.  The poorest and most food-insecure regions around the globe are the most vulnerable." # Already scarce land and water resources will likely become even more scarce, and insufficient technical and financial means will make adaptation to a changing climate very difficult."
...
if (region_to_report == "REU") short_text <- "The severity and speed of climate change is presenting an unprecedented challenge. Current global surface temperatures are now about 0.6 degrees Celsius higher than the average for the last century. This increase is consistent with model predictions of the effects of rising atmospheric concentrations of carbon dioxide (CO2) and other GHGs, which are a result of human activity. The poorest and most food-insecure regions around the globe are the most vulnerable. Already scarce land and water resources will likely become even scarcer, and insufficient technical and financial means will make adaptation to a changing climate very difficult."
