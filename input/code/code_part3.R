...
if (region_to_report == "RNE") short_text <- "The dietary energy supply (DES) is the food available for human consumption, expressed in kilocalories per person per day. At the country level, it is calculated as a measure of food available for human use after taking out all non-food utilization, including exports, industrial use, animal feed, seed, wastage and changes in stocks. The average dietary energy availability in the region is quite high as it reached 3 183 kcal/cap/day in 2014. The average dietary energy supply adequacy is also high and around 136\\%."
...
if (region_to_report == "RNE") short_text <- "Wheat, sugar cane, tomatoes, potatoes and sugar beet, make up the majority of the production of the crop sector. They continue to be the most important food source for human consumption. While Morocco, Iran and Syria are the top per capita wheat producing countries, Egypt, Iran and Morocco are the top per capita sugar cane producing countries. Since 2010, Near East countries have been showing the higher yield of cereals after Gulf States were the best in the region, probably at higher costs of production."
