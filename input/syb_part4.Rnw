...
<<P4energyData, cache=TRUE,results='hide', eval=P4energy>>=
...
if (region_to_report == "RAF") caption_text <- "Production of selected forest products"
if (region_to_report == "RAP") caption_text <- "Production of selected forest products"
if (region_to_report == "REU") caption_text <- "Production of selected forest products"
if (region_to_report == "RNE") caption_text <- "Production of selected forest products"
if (region_to_report == "GLO") caption_text <- "Production of selected forest products"
@
...
if (region_to_report == "RAF") caption_text <- "Top 20 exporters of forest products (2012)"
if (region_to_report == "RAP") caption_text <- "Top 20 exporters of forest products (2012)"
if (region_to_report == "REU") caption_text <- "Top 20 exporters of forest products (2012)"
if (region_to_report == "RNE") caption_text <- "Top 20 exporters of forest products (2012)"
if (region_to_report == "GLO") caption_text <- "Top 20 exporters of forest products (2012)"
...
if (region_to_report == "RAF") caption_text <- "Top 20 importers of forest products (2012)"
if (region_to_report == "RAP") caption_text <- "Top 20 importers of forest products (2012)"
if (region_to_report == "REU") caption_text <- "Top 20 importers of forest products (2012)"
if (region_to_report == "RNE") caption_text <- "Top 20 importers of forest products (2012)"
if (region_to_report == "GLO") caption_text <- "Top 20 importers of forest products (2012)"
...
if (region_to_report == "RAF") caption_text <- "Forest characteristics (2010)"
if (region_to_report == "RAP") caption_text <- "Forest characteristics (2010)"
if (region_to_report == "REU") caption_text <- "Forest characteristics (2010)"
if (region_to_report == "RNE") caption_text <- "Forest characteristics (2010)"
if (region_to_report == "GLO") caption_text <- "Forest characteristics (2010)"
...
if (region_to_report == "RAF") caption_text <- "Forest area as share of total land area"
if (region_to_report == "RAP") caption_text <- "Forest area as share of total land area"
if (region_to_report == "REU") caption_text <- "Forest area as share of total land area"
if (region_to_report == "RNE") caption_text <- "Forest area as share of total land area"
if (region_to_report == "GLO") caption_text <- "Forest area as share of total land area"
@
...
if (region_to_report == "RAF") caption_text <- "Greenhouse gas emissions in agriculture"
if (region_to_report == "RAP") caption_text <- "Greenhouse gas emissions in agriculture"
if (region_to_report == "REU") caption_text <- "Greenhouse gas emissions in agriculture"
if (region_to_report == "RNE") caption_text <- "Greenhouse gas emissions in agriculture"
if (region_to_report == "GLO") caption_text <- "Greenhouse gas emissions in agriculture"
@
...
if (region_to_report == "RAF") caption_text <- "Greehouse gas emissions in agriculture, highest 20 countries in 2012"
if (region_to_report == "RAP") caption_text <- "Greehouse gas emissions in agriculture, highest 20 countries in 2012"
if (region_to_report == "REU") caption_text <- "Greehouse gas emissions in agriculture, highest 20 countries in 2012"
if (region_to_report == "RNE") caption_text <- "Greehouse gas emissions in agriculture, highest 20 countries in 2012"
if (region_to_report == "GLO") caption_text <- "Greehouse gas emissions in agriculture, highest 20 countries in 2012"
...
if (region_to_report == "RAF") caption_text <- "Land use total emissions, highest 20 countries in 2012"
if (region_to_report == "RAP") caption_text <- "Land use total emissions, highest 20 countries in 2012"
if (region_to_report == "REU") caption_text <- "Land use total emissions, highest 20 countries in 2012"
if (region_to_report == "RNE") caption_text <- "Land use total emissions, highest 20 countries in 2012"
if (region_to_report == "GLO") caption_text <- "Land use total emissions, highest 20 countries in 2012"
...
if (region_to_report == "RAF") caption_text <- "Emissions by subsectors in 2012 - figure differs, check!!"
if (region_to_report == "RAP") caption_text <- "Emissions by subsectors in 2012 - figure differs, check!!"
if (region_to_report == "REU") caption_text <- "Emissions by subsectors in 2012 - figure differs, check!!"
if (region_to_report == "RNE") caption_text <- "Emissions by subsectors in 2012 - figure differs, check!!"
if (region_to_report == "GLO") caption_text <- "Emissions by subsectors in 2012 - figure differs, check!!"
...
if (region_to_report == "RAF") caption_text <- "Total greenhouse gas emissions from agriculture, forestry and other land use, gigagrams CO2 eq (2012)"
if (region_to_report == "RAP") caption_text <- "Total greenhouse gas emissions from agriculture, forestry and other land use, gigagrams CO2 eq (2012)"
if (region_to_report == "REU") caption_text <- "Total greenhouse gas emissions from agriculture, forestry and other land use, gigagrams CO2 eq (2012)"
if (region_to_report == "RNE") caption_text <- "Total greenhouse gas emissions from agriculture, forestry and other land use, gigagrams CO2 eq (2012)"
if (region_to_report == "GLO") caption_text <- "Total greenhouse gas emissions from agriculture, forestry and other land use, gigagrams CO2 eq (2012)"
@
