<<part7_setup, eval=include_part6>>=
...
## Part 7
colPart7 <- plot_colors(part = syb_part, 12)
col.main1 <- colPart6[["Main"]][1]
## color for the grid
col.main2 <- colPart7[["Main"]][2]
...
<<P7coffeeTEXT, eval=P7coffee, short_text_ChartPage=P7coffee>>=
spread_title <- "Happiness and coffee"
...
<<P7coffeeData,results='hide'>>=


@


<<P7coffeeTOPRIGHT, eval=P7coffee, top_right_plot=P7coffee, fig.height=top_right_plot_height, fig.width=top_right_plot_width>>=
...
# Caption
if (region_to_report == "COF") caption_text <- "Land area COFFEE"
...
<<P7coffeeLEFT, eval=P7coffee, left_plot=P7coffee, fig.height=left_plot_height, fig.width=left_plot_width>>=
...
if (region_to_report == "COF") caption_text <- "Arable land per capita COFFEE"
...
<<P7coffeeRIGHT, eval=P7coffee ,right_plot=P7coffee, fig.height=right_plot_height, fig.width=right_plot_width>>=
dat_plot <- bottom20
...
<<P7coffeeBOTTOM, eval=P7coffee, bottom_plot=P7coffee, fig.height=bottom_plot_height, fig.width=bottom_plot_width>>=
...
<<P7coffeeMAP, eval=P7coffee, map_plot=P7coffee, fig.width=map.fig.width, fig.height= map.fig.height ,out.width=map.out.width, out.height=map.out.height, out.extra=map.out.extra>>=
dat <- filter(syb.df, Year %in% 2012) %>% select(FAOST_CODE,
