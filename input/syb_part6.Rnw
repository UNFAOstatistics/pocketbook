...
<<P6coffeeprodData, cache=FALSE,results='hide', eval=P6coffeeprod>>=
@
...
<<P6coffeetradeData, cache=FALSE,results='hide', eval=P6coffeetrade>>=
@
...
<<P6coffeepricesData, cache=FALSE,results='hide', eval=P6coffeeprices>>=
@
