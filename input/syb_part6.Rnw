...
<<P6coffeeTEXT, eval=P6coffee, short_text_ChartPage=P6coffee>>=
spread_title <- "Coffee consumption"
...
<<P6coffeeData,results='hide'>>=


@


<<P6coffeeTOPRIGHT, eval=P6coffee, top_right_plot=P6coffee, fig.height=top_right_plot_height, fig.width=top_right_plot_width>>=
...
<<P6coffeeLEFT, eval=P6coffee, left_plot=P6coffee, fig.height=left_plot_height, fig.width=left_plot_width>>=
...
<<P6coffeeRIGHT, eval=P6coffee ,right_plot=P6coffee, fig.height=right_plot_height, fig.width=right_plot_width>>=
dat_plot <- bottom20
...
<<P6coffeeBOTTOM, eval=P6coffee, bottom_plot=P6coffee, fig.height=bottom_plot_height, fig.width=bottom_plot_width>>=
...
<<P6coffeeMAP, eval=P6coffee, map_plot=P6coffee, fig.width=map.fig.width, fig.height= map.fig.height ,out.width=map.out.width, out.height=map.out.height, out.extra=map.out.extra>>=
dat <- filter(syb.df, Year %in% 2012) %>% select(FAOST_CODE,
