...
# 
print(
  xtable(overview_data, caption = "Countries included"), type = "latex", table.placement = NULL, booktabs = TRUE, include.rownames = FALSE, size = "scriptsize", caption.placement = "top"
)
@
