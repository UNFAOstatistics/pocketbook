...
if (region_to_report == "RNE") map.out.height  <- "1.0\\columnwidth"
if (region_to_report == "RNE") map.out.extra  <- 'angle=90'
...
create_map_here <- function(nCol=5,addNA=FALSE){
...
if (addNA) mapColors <- c("grey70", mapColors)
