...
# Sync to kapsi!!
if (Sys.info()["nodename"] =="markus-desktop-mint18" & Sys.info()["user"] == "aurelius")     system('rsync -avzhe "ssh -i /home/aurelius/avaimet/nuc-rsync-key" --progress --delete /home/aurelius/faosync/pocketbooks/pocketbook/output/ pi@82.181.175.116:/var/www/html/fao/pocketbooks/')
if (Sys.info()["nodename"] =="markus-x220") system('rsync -avzhe "ssh -i /home/aurelius/avaimet/x220-rsync-key" --progress --delete /home/aurelius/faosync/pocketbooks/pocketbook/output/ pi@82.181.175.116:/var/www/html/fao/pocketbooks/')
if (Sys.info()["nodename"] == "markus-T430")              system('rsync -avzhe "ssh -i /home/aurelius/avaimet/t430-rsync-key" --progress --delete /home/aurelius/faosync/pocketbooks/pocketbook/output/ pi@82.181.175.116:/var/www/html/fao/pocketbooks/')
if (Sys.info()["nodename"] =="markus-desktop-mint18" & Sys.info()["user"] == "amanda")     system('rsync -avzhe "ssh -i /home/amanda/avaimet/amanda-rsync-key" --progress --delete /home/amanda/faosync/pocketbooks/pocketbook/output/ pi@82.181.175.116:/var/www/html/fao/pocketbooks/')