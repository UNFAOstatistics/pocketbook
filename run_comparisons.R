...
if (Sys.info()["nodename"] =="markus-desktop-mint18" & Sys.info()["user"] == "amanda")     system('rsync -avzhe "ssh -i /home/amanda/avaimet/amanda-rsync-key" --progress /home/amanda/faosync/pocketbooks/pocketbook/output/ pi@82.181.175.116:/var/www/html/fao/pocketbooks/')
